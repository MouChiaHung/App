...
public final class CropImage {
  ...
  private static String generateFileNameBasedOnTimeStamp() {
  ...
  public static Uri getCaptureImageOutputUri(@NonNull Context context) {
    ...
    //File getImage = context.getFilesDir();
    //amo add end
    if (getImage != null) {
      //outputFileUri = Uri.fromFile(new File(getImage.getPath(), "pickImageResult" + generateFileNameBasedOnTimeStamp()));
