...
public class CardsProvider extends ContentProvider {
    private final static String CONTENT_PROVIDER_URI_AUTHORITY = "com.ours.yours.app.dao.CardsProvider";
    private final static String CONTENT_PROVIDER_URI_TABLE = SQLHelper.DEFAULT_DATABASE_NAME;
    private final static String CONTENT_PROVIDER_MIME_TYPE = "vnd.android.cursor.dir" + "/" + "ours.cards";
    ...
    public boolean onCreate() {
        ...
        try {
            if (mDao.create(getContext(), Class.forName("com.ours.yours.app.entity.Card"), CONTENT_PROVIDER_URI_TABLE) != null) ret = true;
